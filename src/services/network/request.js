...
console.log('enableLoading ', enableLoading)
service.setLoading = (enabled = true) => { enableLoading = enabled }
service.loadingUi = {}
...
service.interceptors.request.use(
  config => {
    ...
    if (enableLoading) {
      service.loadingUi = Loading.service({ fullscreen: true })
    }
    return config
  },
  error => {
