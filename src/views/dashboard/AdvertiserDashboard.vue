<template>
  ...
  <div class="main-container container-fluid">
          ...
          <div class="col-lg-6 col-md-6 col-sm-12 col-xl-3">
            <div class="card overflow-hidden">
              <div class="card-body">
                <div class="d-flex">
                  <div class="mt-2">
                    <h6 class="">Total Spend</h6>
                    <h2 class="mb-0 number-font">$ {{ summary.total_spend }}</h2>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div class="card-body">
                <div class="d-flex">
                  <div class="mt-2">
                    ...
                    <h2 class="mb-0 number-font"> {{ summary.total_ads }}</h2>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="col-lg-6 col-md-6 col-sm-12 col-xl-3">
            <div class="card overflow-hidden">
              <div class="card-body">
                <div class="d-flex">
                  <div class="mt-2">
                    <h6 class="">Remaining Auditions</h6>
                    <h2 class="mb-0 number-font"> {{ summary.remaining_audition }}</h2>
                  </div>
                </div>
              </div>
            </div>
    ...
    <div class="row">
      <div class="col-12">
        <div class="card height-xl">
          <div class="card-header">
            <h3 class="card-title">Operator Chart</h3>
          </div>
          <div class="card-body">
...
export default {
  ...
  methods: {
    getDashboard() {
      Portal.advertiserDashboard().then(res => {
