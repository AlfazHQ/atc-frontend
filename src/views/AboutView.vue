<template>
  <div class="about">
      ...
      <header class="header navbar navbar-expand-sm">
        ...
        <ul class="navbar-item flex-row search-ul">
          <li class="nav-item align-self-center search-animated">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-search toggle-search"><circle cx="11" cy="11" r="8" /><line x1="21" y1="21" x2="16.65" y2="16.65" /></svg>
        ...
        <ul class="navbar-item flex-row navbar-dropdown">
          <li class="nav-item dropdown language-dropdown more-dropdown">
            <div class="dropdown  custom-dropdown-icon">
              <a id="customDropdown" class="dropdown-toggle btn" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img src="@/assets/img/flag-ca.svg" class="flag-width" alt="flag"><span>English</span> <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-chevron-down"><polyline points="6 9 12 15 18 9" /></svg></a>
          ...
          <li class="nav-item dropdown message-dropdown">
            <a id="messageDropdown" href="javascript:void(0);" class="nav-link dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-message-circle"><path d="M21 11.5a8.38 8.38 0 0 1-.9 3.8 8.5 8.5 0 0 1-7.6 4.7 8.38 8.38 0 0 1-3.8-.9L3 21l1.9-5.7a8.38 8.38 0 0 1-.9-3.8 8.5 8.5 0 0 1 4.7-7.6 8.38 8.38 0 0 1 3.8-.9h.5a8.48 8.48 0 0 1 8 8v.5z" /></svg><span class="badge badge-primary" />
            </a>
          ...
          <li class="nav-item dropdown notification-dropdown">
            <a id="notificationDropdown" href="javascript:void(0);" class="nav-link dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-bell"><path d="M18 8A6 6 0 0 0 6 8c0 7-3 9-3 9h18s-3-2-3-9" /><path d="M13.73 21a2 2 0 0 1-3.46 0" /></svg><span class="badge badge-success" />
            </a>
          ...
          <li class="nav-item dropdown user-profile-dropdown  order-lg-0 order-1">
            <a id="userProfileDropdown" href="javascript:void(0);" class="nav-link dropdown-toggle user" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
            ...
            <div class="dropdown-menu position-absolute" aria-labelledby="userProfileDropdown">
              ...
              <div class="dropdown-item">
                <a href="user_profile.html">
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-user"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2" /><circle cx="12" cy="7" r="4" /></svg> <span> Profile</span>
                </a>
              </div>
              <div class="dropdown-item">
                <a href="apps_mailbox.html">
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-inbox"><polyline points="22 12 16 12 14 15 10 15 8 12 2 12" /><path d="M5.45 5.11L2 12v6a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2v-6l-3.45-6.89A2 2 0 0 0 16.76 4H7.24a2 2 0 0 0-1.79 1.11z" /></svg> <span> Inbox</span>
                </a>
              </div>
              <div class="dropdown-item">
                <a href="auth_lockscreen.html">
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-lock"><rect x="3" y="11" width="18" height="11" rx="2" ry="2" /><path d="M7 11V7a5 5 0 0 1 10 0v4" /></svg> <span>Lock Screen</span>
                </a>
              </div>
              <div class="dropdown-item">
                <a href="auth_login.html">
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-log-out"><path d="M9 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h4" /><polyline points="16 17 21 12 16 7" /><line x1="21" y1="12" x2="9" y2="12" /></svg> <span>Log Out</span>
                </a>
              </div>
            </div>
          </li>
    ...
    <div id="container" class="main-container sidebar-closed1 sbar-open1">
        ...
        <nav id="sidebar">
          ...
          <ul id="accordionExample" class="list-unstyled menu-categories">
            <li class="menu">
              ...
              <ul id="dashboard" class="collapse submenu list-unstyled" data-parent="#accordionExample">
                <li>
            ...
            <li class="menu menu-heading">
              <div class="heading"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-circle"><circle cx="12" cy="12" r="10" /></svg><span>APPS</span></div>
            </li>
            ...
            <li class="menu">
              ...
              <ul id="invoice" class="collapse submenu list-unstyled" data-parent="#accordionExample">
                <li>
            ...
            <li class="menu menu-heading">
              <div class="heading"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-circle"><circle cx="12" cy="12" r="10" /></svg><span>USER INTERFACE</span></div>
            </li>
            ...
            <li class="menu">
              ...
              <ul id="components" class="collapse submenu list-unstyled" data-parent="#accordionExample">
                <li>
            ...
            <li class="menu">
              ...
              <ul id="elements" class="collapse submenu list-unstyled" data-parent="#accordionExample">
                <li>
            ...
            <li class="menu">
              <a href="fonticons.html" aria-expanded="false" class="dropdown-toggle">
                <div class="">
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-target"><circle cx="12" cy="12" r="10" /><circle cx="12" cy="12" r="6" /><circle cx="12" cy="12" r="2" /></svg>
            ...
            <li class="menu menu-heading">
              <div class="heading"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-circle"><circle cx="12" cy="12" r="10" /></svg><span>TABLES AND FORMS</span></div>
            </li>

            <li class="menu">
              <a href="table_basic.html" aria-expanded="false" class="dropdown-toggle">
                <div class="">
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-layout"><rect x="3" y="3" width="18" height="18" rx="2" ry="2" /><line x1="3" y1="9" x2="21" y2="9" /><line x1="9" y1="21" x2="9" y2="9" /></svg>
                  <span>Tables</span>
                </div>
              </a>
            </li>
            ...
            <li class="menu">
              ...
              <ul id="datatables" class="collapse submenu list-unstyled" data-parent="#accordionExample">
                <li>
            ...
            <li class="menu active">
              ...
              <ul id="forms" class="collapse submenu recent-submenu mini-recent-submenu list-unstyled show" data-parent="#accordionExample">
                <li>
            ...
            <li class="menu menu-heading">
              <div class="heading"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-circle"><circle cx="12" cy="12" r="10" /></svg><span>USER AND PAGES</span></div>
            </li>
            ...
            <li class="menu">
              ...
              <ul id="users" class="collapse submenu list-unstyled" data-parent="#accordionExample">
                <li>
            ...
            <li class="menu">
              ...
              <ul id="pages" class="collapse submenu list-unstyled" data-parent="#accordionExample">
                <li>
                ...
                <li>
                  ...
                  <ul id="pages-error" class="collapse list-unstyled sub-submenu" data-parent="#pages">
                    <li>
            ...
            <li class="menu menu-heading">
              <div class="heading"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-circle"><circle cx="12" cy="12" r="10" /></svg><span>EXTRA ELEMENTS</span></div>
            </li>
            ...
            <li class="menu">
              ...
              <ul id="authentication" class="collapse submenu list-unstyled" data-parent="#accordionExample">
                <li>
            ...
            <li class="menu">
              <a href="#starter-kit" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">
                <div class="">
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-terminal"><polyline points="4 17 10 11 4 5" /><line x1="12" y1="19" x2="20" y2="19" /></svg>
              ...
              <ul id="starter-kit" class="collapse submenu list-unstyled" data-parent="#accordionExample">
                <li>
                  ...
                  <div class="widget-content widget-content-area">
                    <form>
                      <div class="form-group mb-3">
                        <input id="sEmail" type="email" class="form-control" aria-describedby="emailHelp1" placeholder="Email address">
                        <small id="emailHelp1" class="form-text text-muted">We'll never share your email with anyone else.</small>
                      </div>
                      <div class="form-group mb-4">
                        <input id="sPassword" type="password" class="form-control" placeholder="Password">
                      </div>
                      <div class="form-group form-check pl-0">
                        <div class="custom-control custom-checkbox checkbox-info">
                          <input id="sChkbox" type="checkbox" class="custom-control-input">
                    ...
                    <form>
                      <div class="form-group row mb-4">
                        ...
                        <div class="col-xl-10 col-lg-9 col-sm-10">
                          <input id="hEmail" type="email" class="form-control" placeholder="">
                        </div>
                      </div>
                      <div class="form-group row mb-4">
                        <label for="hPassword" class="col-xl-2 col-sm-3 col-sm-2 col-form-label">Password</label>
                        <div class="col-xl-10 col-lg-9 col-sm-10">
                          <input id="hPassword" type="password" class="form-control" placeholder="">
                        </div>
                      </div>
                          ...
                          <div class="col-xl-10 col-lg-9 col-sm-10">
                            <div class="form-check mb-2">
                              <div class="custom-control custom-radio classic-radio-info">
                                <input id="hRadio1" type="radio" name="classicRadio" class="custom-control-input">
                                <label class="custom-control-label" for="hRadio1">Segements 1</label>
                              </div>
                            </div>
                            <div class="form-check mb-2">
                              <div class="custom-control custom-radio classic-radio-info">
                                <input id="hRadio2" type="radio" name="classicRadio" class="custom-control-input">
                            ...
                            <div class="form-check disabled">
                              <div class="custom-control custom-radio classic-radio-default">
                                <input id="hRadio3" type="radio" name="classicRadio" class="custom-control-input" disabled>
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                          <div class="form-check pl-0">
                            ...
                            <div class="custom-control custom-checkbox checkbox-info">
                              <input id="hChkbox" type="checkbox" class="custom-control-input">
              ...
              <div id="flRegistrationForm" class="col-lg-12 layout-spacing">
                <div class="statbox widget box box-shadow">
                  ...
                  <div class="widget-content widget-content-area">
                    <form>
                      <div class="form-group mb-4">
                        <input id="rEmail" type="email" class="form-control" placeholder="Email address *">
                      </div>
                      <div class="form-group mb-4">
                        <input id="rPassword" type="password" class="form-control" placeholder="Password *">
                      </div>
                      <div class="form-group">
                        <input id="rConfirmPassword" type="password" class="form-control" placeholder="Confirm Password *">
                      </div>
                      <small id="emailHelp2" class="form-text text-muted">*Required Fields</small>
                      <div class="form-group form-check pl-0 mt-5">
                        <div class="custom-control custom-checkbox checkbox-info">
                          <input id="rChkbox" type="checkbox" class="custom-control-input">
              ...
              <div id="flLoginForm" class="col-lg-12 layout-spacing">
                <div class="statbox widget box box-shadow">
                  ...
                  <div class="widget-content widget-content-area">
                    <form>
                      <div class="form-group mb-4">
                        <input id="lFullName" type="text" class="form-control" placeholder="Full Name *">
                      </div>
                      <div class="form-group mb-4">
                        <input id="lEmail" type="email" class="form-control" placeholder="Email address *">
                      </div>
                      <div class="form-group">
                    ...
                    <form>
                      <div class="form-row mb-4">
                        ...
                        <div class="form-group col-md-6">
                          ...
                          <input id="inputPassword4" type="password" class="form-control" placeholder="Password">
                        </div>
                      </div>
                      <div class="form-group mb-4">
                      ...
                      <div class="form-group">
                        <div class="form-check pl-0">
                          <div class="custom-control custom-checkbox checkbox-info">
                            <input id="gridCheck" type="checkbox" class="custom-control-input">
                ...
                <div class="statbox widget box box-shadow">
                  ...
                  <div class="widget-content widget-content-area">
                    <form class="form-inline justify-content-center">
                      ...
                      <input id="inlineFormInputName2" type="text" class="form-control mb-2 mr-sm-2" placeholder="Jane Doe">
                      <label class="sr-only" for="inlineFormInputGroupUsername2">Username</label>
                      <div class="input-group mb-2 mr-sm-2">
                        <div class="input-group-prepend">
                          <div class="input-group-text">@</div>
                        </div>
                        <input id="inlineFormInputGroupUsername2" type="text" class="form-control" placeholder="Username">
                      </div>
                      <div class="form-check mb-2 mr-sm-2">
                        <div class="custom-control custom-checkbox checkbox-info">
                          <input id="inlineFormCheck" type="checkbox" class="custom-control-input">
                    ...
                    <form>
                      <div class="form-row align-items-center justify-content-center">
                        <div class="col-auto">
                          ...
                          <input id="inlineFormInput" type="text" class="form-control mb-2" placeholder="Jane Doe">
                        </div>
                        <div class="col-auto">
                          ...
                          <div class="input-group mb-2">
                            ...
                            <input id="inlineFormInputGroup" type="text" class="form-control" placeholder="Username">
                          </div>
                        </div>
                        <div class="col-auto">
                          <div class="form-check mb-2 pl-0">
                            <div class="custom-control custom-checkbox checkbox-info">
                              <input id="autoSizingCheck" type="checkbox" class="custom-control-input">
