<template>
  <div class="main-area">
    <section class="container">
      <h1 class="text-center mt-8">Ads Selection</h1>
      <div class="row mt-5">
        <div class="col-12 col-sm-12">
          <div class="card">
            ...
            <div class="card-body pt-4">
              <ad-items key="popular" :items="popularItems" :breakpoints="slider.breakpoints" />
            </div>
          </div>
        </div>
      </div>
...
export default {
  ...
  computed: {
    ...
    popularItems() {
      ...
      console.log('this.popular_query ', this.popular_query)
